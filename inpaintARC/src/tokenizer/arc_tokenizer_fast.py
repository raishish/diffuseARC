...
class ARCTokenizerFast(PreTrainedTokenizerFast):
    ...
    def __init__(self, vocab: Sequence[str], model_max_length: int, **kwargs):
        ...
        self._vocab.extend(arc_special_tokens + special_tokens)

        self._vocab_str_to_int = {}
        for id, token in enumerate(self._vocab):
        ...
        super().__init__(
            tokenizer_object=self,  # pass the self object to get the fast tokenizer class instance
            arc_sep_example_token=str(arc_sep_example_token),
            arc_sep_grid_token=str(arc_sep_grid_token),
            arc_sep_row_token=str(arc_sep_row_token),
            arc_grid_endx_token=str(arc_grid_endx_token),
            arc_grid_endy_token=str(arc_grid_endy_token),
            arc_grid_endxy_token=str(arc_grid_endxy_token),
            arc_pad_token=str(arc_pad_token),
        ...
        # make sure the tokenizer object is set
    ...
    @classmethod
    def from_config(cls, config: Dict) -> "ARCTokenizerFast":
        cfg = {}
