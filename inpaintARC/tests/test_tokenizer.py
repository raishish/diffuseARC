from src.tokenizer.arc_tokenizer_fast import ARCTokenizerFast


def test_arc_tokenizer_vocab_size(model_to_load: str = "../configs/v2"):
    """Tests the vocab size of the ARCTokenizer."""
    tokenizer = ARCTokenizerFast.from_pretrained(model_to_load)
...
def test_arc_tokenizer_encode_decode(model_to_load: str = "../configs/v2"):
    """Tests the encode and decode methods of the ARC tokenizer."""
    tokenizer = ARCTokenizerFast.from_pretrained(model_to_load)
    ...
    sample_task_str = "212<arc_grid_endx><arc_pad><arc_sep_row><arc_sep_grid>1212<arc_grid_endx><arc_sep_row>" + \
                      ...
                      "<arc_grid_endy><arc_grid_endy><arc_grid_endy><arc_grid_endxy><arc_grid_endy><arc_sep_row>" + \
                      "<arc_sep_grid>" + \
